...
class Mex(nn.Module):
    ...
    stride=1, padding=0, dilation=1, groups=1,beta=3):
...
if __name__ == '__main__':
    sim = Similarity(3, 4, (3,3), 2,1, bias = None,sim_type='l1')
    mex = Mex(2,2)
    conv = torch.nn.Conv2d(3, 4,(3,3),2,1, bias=False)
